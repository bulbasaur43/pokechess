...
export const SHOP_ITEMS = {
  ...
  AGILITY_BAND: {
    ...
    emoji: '💨',
    coinCost: 250,
    description: 'Gives a piece +1 move range for 5 turns (stacks with bike mode)',
    useDescription: 'Click a piece to equip',
    color: '#38bdf8',
    usesPerPurchase: 3,
    cooldownBattles: 0,
    hidden: true,
  ...
  SHADOW_CLOAK: {
    ...
    emoji: '🌑',
    coinCost: 400,
    description: 'Makes a piece permanently immune to abilities',
    useDescription: 'Click a piece to cloak',
    color: '#6366f1',
    usesPerPurchase: 2,
    cooldownBattles: 0,
    hidden: true,
  ...
  TOXIC_ORB: {
    ...
    emoji: '☠️',
    coinCost: 350,
    description: 'Poisons an enemy piece, dealing 1 damage per turn for 3 turns',
    useDescription: 'Click an enemy piece to poison',
    color: '#a855f7',
    usesPerPurchase: 2,
    cooldownBattles: 0,
    hidden: true,
  ...
  CHOICE_SCARF: {
    ...
    useDescription: 'Click two friendly pieces to swap',
    color: '#f472b6',
    usesPerPurchase: 5,
    cooldownBattles: 0,
  },
  EJECT_BUTTON: {
    ...
    emoji: '🔘',
    coinCost: 100,
    description: 'Teleport a piece to any empty square',
    useDescription: 'Click a piece, then an empty square',
    color: '#fb923c',
    usesPerPurchase: 5,
    cooldownBattles: 0,
  },
  WIDE_LENS: {
    ...
    emoji: '🔍',
    coinCost: 200,
    description: 'Doubles ability damage for one piece this game',
    useDescription: 'Click a friendly piece to enhance',
    color: '#67e8f9',
    usesPerPurchase: 3,
    cooldownBattles: 0,
  },
  LIFE_ORB: {
    ...
    emoji: '🔮',
    coinCost: 175,
    description: '+3 damage but lose 2 HP per attack',
    useDescription: 'Click a friendly piece to empower',
    color: '#f43f5e',
    usesPerPurchase: 5,
    cooldownBattles: 0,
  },
  SHIELD_DUST: {
    ...
    emoji: '🛡️',
    coinCost: 90,
    description: 'Prevents all status effects (poison, freeze, stun, paralyze)',
    useDescription: 'Click a friendly piece to protect',
    color: '#d4d4d8',
    usesPerPurchase: 10,
    cooldownBattles: 0,
  },
