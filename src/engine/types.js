...
export const POKEMON = {
  ...
  // Scarlet classics
  BULBASAUR:    { name: 'Bulbasaur',    types: ['GRASS','POISON'],     team: 'scarlet', emoji: '🌱', img: SPRITE(1),    desc: 'Ancient Seed',          hp: 9,  maxHp: 9,  damage: 3, damageTier: 'standard' },
  ...
  CHI_YU:       { name: 'Chi-Yu',       types: ['DARK','FIRE'],        team: 'scarlet', emoji: '🐟', img: SPRITE(1004), desc: 'Ruinous Pokémon',       hp: 6,  maxHp: 6,  damage: 4, damageTier: 'heavy' },
  ...
  TYRANITAR:    { name: 'Tyranitar',    types: ['ROCK','DARK'],        team: 'scarlet', emoji: '🦖', img: SPRITE(248),  desc: 'Armor Pokémon',         hp: 9,  maxHp: 9,  damage: 3, damageTier: 'standard' },
  ...
  VENUSAUR:     { name: 'Venusaur',     types: ['GRASS','POISON'],     team: 'scarlet', emoji: '🌺', img: SPRITE(3),    desc: 'Seed Pokémon',          hp: 9,  maxHp: 9,  damage: 3, damageTier: 'standard' },
  ...
  IRON_HANDS:   { name: 'Iron Hands',   types: ['FIGHTING','ELECTRIC'],team: 'violet',  emoji: '🤖', img: SPRITE(992),  desc: 'Future Hariyama',       hp: 9,  maxHp: 9,  damage: 3, damageTier: 'standard' },
  ...
  // Violet classics
  PIKACHU:      { name: 'Pikachu',      types: ['ELECTRIC','STEEL'],   team: 'violet',  emoji: '⚡', img: SPRITE(25),   desc: 'Future Mouse',          hp: 9,  maxHp: 9,  damage: 3, damageTier: 'standard' },
  ...
  CHIEN_PAO:    { name: 'Chien-Pao',    types: ['DARK','ICE'],         team: 'violet',  emoji: '🐆', img: SPRITE(1002), desc: 'Ruinous Pokémon',       hp: 6,  maxHp: 6,  damage: 4, damageTier: 'heavy' },
  ZAPDOS:       { name: 'Zapdos',       types: ['ELECTRIC','FLYING'],  team: 'scarlet', emoji: '⚡', img: SPRITE(145),  desc: 'Electric Pokémon',      hp: 7,  maxHp: 7,  damage: 3, damageTier: 'standard' },
  ...
  KINGAMBIT:    { name: 'Kingambit',    types: ['DARK','STEEL'],       team: 'violet',  emoji: '♚', img: SPRITE(983),  desc: 'Big Boss Pokémon',      hp: 9,  maxHp: 9,  damage: 3, damageTier: 'standard' },
...
export const ABILITIES = {
  ...
  GREAT_TUSK:   { name: 'Earthquake',      effect: 'damage',  damage: 2,         targets: 'adjacent_all',     emoji: '🏔️', color: '#e0c068' },
  ...
  GOUGING_FIRE: { name: 'Burning Bulwark', effect: 'damage',  damage: 2,         targets: 'adjacent_enemies', emoji: '🔥', color: '#f08030' },
  BULBASAUR:    { name: 'Vine Drain',      effect: 'drain',   damage: 1, heal: 2,targets: 'adjacent_enemies', emoji: '☠️', color: '#50c030', bonusStatus: 'poisoned', bonusTargets: 'random_1' },
  ...
  GARCHOMP:     { name: 'Rough Skin',      effect: 'damage',  damage: 2,         targets: 'adjacent_enemies', emoji: '🦈', color: '#e0c068' },
  ...
  CHI_YU:       { name: 'Ruination',       effect: 'damage',  damage: 3,         targets: 'random_1',         emoji: '🔥', color: '#f08030' },
  ...
  TINKATON:     { name: 'Gigaton Hammer',  effect: 'damage',  damage: 3,         targets: 'random_1',         emoji: '🔨', color: '#b8b8d0' },
  // Scarlet pack-only
  ...
  IRON_LEAVES:  { name: 'Psyblade',        effect: 'damage',  damage: 2,         targets: 'adjacent_enemies', emoji: '🍃', color: '#78c850' },
  PIKACHU:      { name: 'Thunder Shock',   effect: 'damage',  damage: 2,         targets: 'adjacent_enemies', emoji: '⚡', color: '#ffdc32', bonusStatus: 'paralyzed', bonusTargets: 'random_1' },
  ...
  CHIEN_PAO:    { name: 'Sword of Ruin',   effect: 'damage',  damage: 2,         targets: 'random_1',         emoji: '❄️', color: '#64c8ff', bonusStatus: 'frozen', bonusTargets: 'random_1' },
  ...
  CERULEDGE:    { name: 'Bitter Blade',    effect: 'drain',   damage: 2, heal: 1,targets: 'random_1',         emoji: '🗡️', color: '#705898' },
