...
export const ABILITIES = {
  ...
  BULBASAUR:    { name: 'Toxic',           effect: 'status',  status: 'poisoned', targets: 'random_1',         emoji: '☠️', color: '#a040a0' },
  ...
  PIKACHU:      { name: 'Thunder Wave',    effect: 'status',  status: 'paralyzed', targets: 'random_1',        emoji: '⚡', color: '#ffdc32' },
