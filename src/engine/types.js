...
export const POKEMON = {
  ...
  WALKING_WAKE: { name: 'Walking Wake', types: ['WATER','DRAGON'],     team: 'scarlet', emoji: '🌊', img: SPRITE(1009), desc: 'Ancient Suicune',       hp: 9,  maxHp: 9,  damage: 4, damageTier: 'heavy' },
  ...
  IRON_LEAVES:  { name: 'Iron Leaves',  types: ['GRASS','PSYCHIC'],    team: 'violet',  emoji: '🍃', img: SPRITE(1010), desc: 'Future Virizion',       hp: 9,  maxHp: 9,  damage: 4, damageTier: 'heavy' },
  // Violet classics
  ...
  LUCARIO:      { name: 'Lucario',      types: ['FIGHTING','STEEL'],   team: 'violet',  emoji: '🐺', img: SPRITE(448),  desc: 'Aura Pokémon',          hp: 9,  maxHp: 9,  damage: 4, damageTier: 'heavy' },
  ...
  BRAMBLEGHAST: { name: 'Brambleghast', types: ['GRASS','GHOST'],      team: 'violet',  emoji: '🌿', img: SPRITE(947),  desc: 'Tumbleweed Pokémon',    hp: 10, maxHp: 10, damage: 4, damageTier: 'heavy' },
  ...
  // Violet pack-only
  PICHU:        { name: 'Pichu',        types: ['ELECTRIC'],           team: 'violet',  emoji: '⚡', img: SPRITE(172),  desc: 'Tiny Mouse Pokémon',    hp: 8,  maxHp: 8,  damage: 3, damageTier: 'standard' },
  RAICHU:       { name: 'Raichu',       types: ['ELECTRIC','PSYCHIC'], team: 'violet',  emoji: '⚡', img: SPRITE(26),   desc: 'Mouse Pokémon',         hp: 10, maxHp: 10, damage: 4, damageTier: 'heavy' },
