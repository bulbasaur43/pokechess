...
export const POKEMON = {
  ...
  CHARIZARD:    { name: 'Charizard',    types: ['FIRE','FLYING'],      team: 'scarlet', emoji: '🔥', img: SPRITE(6),    desc: 'Flame Pokémon',         hp: 7,  maxHp: 7,  damage: 3, damageTier: 'standard' },
  ...
  SCEPTILE:     { name: 'Sceptile',     types: ['GRASS'],              team: 'scarlet', emoji: '🦎', img: SPRITE(254),  desc: 'Forest Pokémon',        hp: 7,  maxHp: 7,  damage: 3, damageTier: 'standard' },
  ...
  INCINEROAR:   { name: 'Incineroar',   types: ['FIRE','DARK'],        team: 'violet',  emoji: '🐯', img: SPRITE(727),  desc: 'Heel Pokémon',          hp: 10, maxHp: 10, damage: 4, damageTier: 'heavy' },
  MAGCARGO:     { name: 'Magcargo',     types: ['FIRE','ROCK'],        team: 'scarlet', emoji: '🐌', img: SPRITE(219),  desc: 'Lava Pokémon',          hp: 9,  maxHp: 9,  damage: 3, damageTier: 'standard' },
  ...
  TINKATON:     { name: 'Tinkaton',     types: ['FAIRY','STEEL'],      team: 'scarlet', emoji: '🔨', img: SPRITE(959),  desc: 'Hammer Pokémon',        hp: 8,  maxHp: 8,  damage: 4, damageTier: 'heavy' },
  // Scarlet pack-only
  IVYSAUR:      { name: 'Ivysaur',      types: ['GRASS','POISON'],     team: 'scarlet', emoji: '🌿', img: SPRITE(2),    desc: 'Seed Pokémon',          hp: 9,  maxHp: 9,  damage: 4, damageTier: 'heavy' },
  ...
  VOLCANION:    { name: 'Volcanion',    types: ['FIRE','WATER'],       team: 'scarlet', emoji: '🌋', img: SPRITE(721),  desc: 'Steam Pokémon',         hp: 10, maxHp: 10, damage: 4, damageTier: 'heavy' },
  LYCANROC:     { name: 'Lycanroc',     types: ['ROCK'],               team: 'scarlet', emoji: '🐺', img: SPRITE(745),  desc: 'Wolf Pokémon',          hp: 9,  maxHp: 9,  damage: 4, damageTier: 'heavy' },
  ...
  IRON_LEAVES:  { name: 'Iron Leaves',  types: ['GRASS','PSYCHIC'],    team: 'violet',  emoji: '🍃', img: SPRITE(1010), desc: 'Future Virizion',       hp: 8,  maxHp: 8,  damage: 4, damageTier: 'heavy' },
  // Violet classics
  PIKACHU:      { name: 'Pikachu',      types: ['ELECTRIC'],           team: 'violet',  emoji: '⚡', img: SPRITE(25),   desc: 'Electric Mouse Pokémon', hp: 12, maxHp: 12, damage: 5, damageTier: 'heavy' },
  ...
  LUCARIO:      { name: 'Lucario',      types: ['FIGHTING','STEEL'],   team: 'violet',  emoji: '🐺', img: SPRITE(448),  desc: 'Aura Pokémon',          hp: 8,  maxHp: 8,  damage: 4, damageTier: 'heavy' },
  ...
  SYLVEON:      { name: 'Sylveon',      types: ['FAIRY'],              team: 'violet',  emoji: '🎀', img: SPRITE(700),  desc: 'Intertwining Pokémon',   hp: 8,  maxHp: 8,  damage: 2, damageTier: 'weak' },
  DRAGAPULT:    { name: 'Dragapult',    types: ['DRAGON','GHOST'],     team: 'violet',  emoji: '🐉', img: SPRITE(887),  desc: 'Stealth Pokémon',       hp: 8,  maxHp: 8,  damage: 4, damageTier: 'heavy' },
  ...
  BRAMBLEGHAST: { name: 'Brambleghast', types: ['GRASS','GHOST'],      team: 'violet',  emoji: '🌿', img: SPRITE(947),  desc: 'Tumbleweed Pokémon',    hp: 9,  maxHp: 9,  damage: 4, damageTier: 'heavy' },
  AUDINO:       { name: 'Audino',       types: ['NORMAL'],             team: 'violet',  emoji: '👂', img: SPRITE(531),  desc: 'Hearing Pokémon',       hp: 8,  maxHp: 8,  damage: 1, damageTier: 'weak' },
  ...
  HATTERENE:    { name: 'Hatterene',    types: ['PSYCHIC','FAIRY'],    team: 'violet',  emoji: '🧙', img: SPRITE(858),  desc: 'Silent Pokémon',        hp: 8,  maxHp: 8,  damage: 3, damageTier: 'standard' },
  // Violet pack-only
  PICHU:        { name: 'Pichu',        types: ['ELECTRIC'],           team: 'violet',  emoji: '⚡', img: SPRITE(172),  desc: 'Tiny Mouse Pokémon',    hp: 15, maxHp: 15, damage: 0, damageTier: 'none', noAttack: true },
  RAICHU:       { name: 'Raichu',       types: ['ELECTRIC'],           team: 'violet',  emoji: '⚡', img: SPRITE(26),   desc: 'Mouse Pokémon',         hp: 10, maxHp: 10, damage: 4, damageTier: 'heavy' },
...
export const POKEMON_POOL = {
  scarlet: [
    ...
    { key: 'GREAT_TUSK',   requiredElo: 1300 },
    ...
    { key: 'GOUGING_FIRE', requiredElo: 800 },
  ...
  violet: [
    ...
    { key: 'IRON_LEAVES',  requiredElo: 1600 },
    { key: 'DRAGAPULT',    requiredElo: 1400 },
    { key: 'CHIEN_PAO',    requiredElo: 1300 },
