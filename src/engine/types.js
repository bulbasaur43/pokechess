...
export const POKEMON = {
  ...
  CHARIZARD:    { name: 'Charizard',    types: ['FIRE','FLYING'],      team: 'scarlet', emoji: '🔥', img: SPRITE(6),    desc: 'Flame Pokémon',         hp: 9,  maxHp: 9,  damage: 4, damageTier: 'heavy' },
  ...
  MAGCARGO:     { name: 'Magcargo',     types: ['FIRE','ROCK'],        team: 'scarlet', emoji: '🐌', img: SPRITE(219),  desc: 'Lava Pokémon',          hp: 11, maxHp: 11, damage: 4, damageTier: 'heavy' },
  ...
  DRAGAPULT:    { name: 'Dragapult',    types: ['DRAGON','GHOST'],     team: 'violet',  emoji: '🐉', img: SPRITE(887),  desc: 'Stealth Pokémon',       hp: 9,  maxHp: 9,  damage: 4, damageTier: 'heavy' },
